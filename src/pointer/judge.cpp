...
bool rm::isLightBarAreaPercentValid(rm::Armor armor, double min_area_percent) {
    ...
    double light_bar_area = cv::norm(armor.four_points[0] - armor.four_points[1])
        * cv::norm(armor.four_points[0] - armor.four_points[2]);
