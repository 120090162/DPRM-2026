...
typedef enum GX_STATUS_LIST {
    ...
    GX_STATUS_INVALID_PARAMETER =
        -5, ///< Invalid parameter. Generally, the pointer is NULL or the input IP and other parameter formats are invalid
    ...
    GX_STATUS_NEED_MORE_BUFFER =
        -9, ///< The user request buffer is insufficient: the user input buffer size during the read operation is less than the actual need
    GX_STATUS_ERROR_TYPE =
        -10, ///< The type of FeatureID used by the user is incorrect, such as an integer interface using a floating-point function code
...
typedef enum GX_FEATURE_ID {
    ...
    GX_STRING_DEVICE_FIRMWARE_VERSION = 2 | GX_FEATURE_STRING
    ...
    GX_STRING_DEVICE_USERID = 7 | GX_FEATURE_STRING
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< User-programmable device identifier.
    GX_INT_DEVICE_LINK_SELECTOR = 8 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which Link of the device to control.
    GX_ENUM_DEVICE_LINK_THROUGHPUT_LIMIT_MODE = 9 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls if the DeviceLinkThroughputLimit is active.
    GX_INT_DEVICE_LINK_THROUGHPUT_LIMIT = 10 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Limits the maximum bandwidth of the data that will be streamed out by the device on the selected Link.
    GX_INT_DEVICE_LINK_CURRENT_THROUGHPUT = 11 | GX_FEATURE_INT
    ...
    GX_STRING_DEVICE_PHY_VERSION =
        18 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Device network chip version
    GX_ENUM_DEVICE_TEMPERATURE_SELECTOR =
        19 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Device temperature selection
    GX_FLOAT_DEVICE_TEMPERATURE =
        20 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Device temperature
    GX_STRING_DEVICE_ISP_FIRMWARE_VERSION =
        21 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Devide isp firmware version
    GX_ENUM_LOWPOWER_MODE = 22 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///<Low power consumption mode, see also GX_LOWPOWER_MODE_ENT
    GX_ENUM_CLOSE_CCD = 23 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Close CCD, refer to GX_CLOSE_CCD_ENTRY
    GX_STRING_PRODUCTION_CODE =
        24 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Production code
    GX_STRING_DEVICE_ORIGINAL_NAME =
        25 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Original name
    GX_INT_REVISION = 26 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< CXP protocol version
    GX_INT_VERSIONS_SUPPORTED =
        27 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Supported CXP protocol versions
    ...
    GX_FLOAT_TEC_TARGET_TEMPERATURE =
        30 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< TEC target temperature
    GX_BOOL_FAN_ENABLE = 31 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Fan switch
    GX_INT_TEMPERATURE_DETECTION_STATUS =
        32 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Temperature state detection
    GX_INT_FAN_SPEED = 33 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Fan speed
    GX_FLOAT_DEVICE_HUMIDITY =
        34 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Equipment humidity
    GX_FLOAT_DEVICE_PRESSURE =
        35 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Equipment air pressure
    GX_INT_AIR_CHANGE_DETECTION_STATUS =
        36 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Ventilation status detection
    GX_INT_AIR_TIGHTNESS_DETECTION_STATUS =
        37 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Airtightness state detection
    ...
    GX_INT_OFFSET_X = 1004 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Horizontal offset from the origin to the region of interest (in pixels).
    GX_INT_OFFSET_Y = 1005 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Vertical offset from the origin to the region of interest (in pixels).
    GX_INT_WIDTH = 1006 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Width of the image provided by the device (in pixels).
    GX_INT_HEIGHT = 1007 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Height of the image provided by the device (in pixels).
    GX_INT_BINNING_HORIZONTAL = 1008 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Number of horizontal photo-sensitive cells to combine together.
    GX_INT_BINNING_VERTICAL = 1009 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Number of vertical photo-sensitive cells to combine together.
    GX_INT_DECIMATION_HORIZONTAL = 1010 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Horizontal sub-sampling of the image.
    GX_INT_DECIMATION_VERTICAL = 1011 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Vertical sub-sampling of the image.
    GX_ENUM_PIXEL_SIZE = 1012 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Total size in bits of a pixel of the image.
    GX_ENUM_PIXEL_COLOR_FILTER = 1013 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Type of color filter that is applied to the image.
    GX_ENUM_PIXEL_FORMAT = 1014 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Format of the pixels provided by the device.
    GX_BOOL_REVERSE_X = 1015 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Flip horizontally the image sent by the device.
    GX_BOOL_REVERSE_Y = 1016 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Flip vertically the image sent by the device.
    GX_ENUM_TEST_PATTERN = 1017 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the type of test pattern that is generated by the device as image source.
    GX_ENUM_TEST_PATTERN_GENERATOR_SELECTOR = 1018 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which test pattern generator is controlled by the TestPattern feature.
    GX_ENUM_REGION_SEND_MODE = 1019 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< ROI output mode, see also GX_REGION_SEND_MODE_ENTRY
    GX_ENUM_REGION_MODE = 1020 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< zone switch, see also GX_REGION_MODE_ENTRY
    GX_ENUM_RREGION_SELECTOR = 1021 | GX_FEATURE_ENUM
    ...
    GX_ENUM_BINNING_HORIZONTAL_MODE = 1024 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Binning Horizontal mode, see also GX_BINNING_HORIZONTAL_MODE_ENTRY
    GX_ENUM_BINNING_VERTICAL_MODE = 1025 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Binning vertical mode, see also GX_BINNING_VERTICAL_MODE_ENTRY
    GX_ENUM_SENSOR_SHUTTER_MODE = 1026 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sensor shutter mode, see also GX_SENSOR_SHUTTER_MODE_ENTRY
    GX_INT_DECIMATION_LINENUMBER =
        1027 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Decimation linenumber
    GX_INT_SENSOR_DECIMATION_HORIZONTAL =
        1028 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sensor decimation horizontal
    GX_INT_SENSOR_DECIMATION_VERTICAL =
        1029 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sensor decimation vertical
    GX_ENUM_SENSOR_SELECTOR = 1030 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Select the current sensor type，see also GX_SENSOR_SELECTOR_ENTRY
    GX_INT_CURRENT_SENSOR_WIDTH =
        1031 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Current sensor image width
    GX_INT_CURRENT_SENSOR_HEIGHT =
        1032 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Current sensor image height
    GX_INT_CURRENT_SENSOR_OFFSETX =
        1033 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Current sensor horizontal offset
    GX_INT_CURRENT_SENSOR_OFFSETY =
        1034 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Current sensor vertical offset
    GX_INT_CURRENT_SENSOR_WIDTHMAX =
        1035 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Maximum current sensor width
    GX_INT_CURRENT_SENSOR_HEIGHTMAX =
        1036 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Maximum current sensor height
    GX_ENUM_SENSOR_BIT_DEPTH = 1037 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sensor Bit Depth, refer to GX_SENSOR_BIT_DEPTH_ENTRY
    ...
    GX_INT_PAYLOAD_SIZE = 2000 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Provides the number of bytes transferred for each image or chunk on the stream channel.
    GX_BOOL_GEV_CURRENT_IPCONFIGURATION_LLA = 2001 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls whether the Link Local Address IP configuration scheme is activated on the given logical link.
    GX_BOOL_GEV_CURRENT_IPCONFIGURATION_DHCP = 2002 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls whether the DHCP IP configuration scheme is activated on the given logical link.
    GX_BOOL_GEV_CURRENT_IPCONFIGURATION_PERSISTENTIP = 2003 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls whether the PersistentIP configuration scheme is activated on the given logical link.
    ...
    GX_INT_GEV_PACKETSIZE = 2006 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Specifies the stream packet size, in bytes, to send on the selected channel for a GVSP transmitter or specifies the maximum packet size supported by a GVSP receiver.
    GX_INT_GEV_PACKETDELAY = 2007 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls the delay (in timestamp counter unit) to insert between each packet for this stream channel.
    GX_INT_GEV_LINK_SPEED = 2008 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< It indicates the connection speed in Mbps for the selected network interface.
    GX_ENUM_DEVICE_TAP_GEOMETRY =
        2009 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Equipment geometry

    //---------------AcquisitionTrigger Section---------------------------
    GX_ENUM_ACQUISITION_MODE = 3000 | GX_FEATURE_ENUM
    ...
    GX_COMMAND_ACQUISITION_STOP = 3002 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Stops the Acquisition of the device at the end of the current Frame.
    GX_INT_ACQUISITION_SPEED_LEVEL = 3003 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Setting the speed level of acquiring image.
    GX_INT_ACQUISITION_FRAME_COUNT = 3004 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Number of frames to acquire in MultiFrame Acquisition mode.
    GX_ENUM_TRIGGER_MODE = 3005 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls if the selected trigger is active.
    GX_COMMAND_TRIGGER_SOFTWARE =
        3006 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Generates an internal trigger.
    GX_ENUM_TRIGGER_ACTIVATION = 3007 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Specifies the activation mode of the trigger.
    GX_ENUM_TRIGGER_SWITCH = 3008 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Control external trigger signal is valid, see also GX_TRIGGER_SWITCH_ENTRY
    GX_FLOAT_EXPOSURE_TIME = 3009 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sets the Exposure time when ExposureMode is Timed and ExposureAuto is Off.
    GX_ENUM_EXPOSURE_AUTO = 3010 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sets the automatic exposure mode when ExposureMode is Timed.
    GX_FLOAT_TRIGGER_FILTER_RAISING = 3011 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Raising edge signal pulse width is smaller than this value is invalid.
    GX_FLOAT_TRIGGER_FILTER_FALLING = 3012 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Falling edge signal pulse width is smaller than this value is invalid.
    GX_ENUM_TRIGGER_SOURCE = 3013 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Specifies the internal signal or physical input Line to use as the trigger source.
    GX_ENUM_EXPOSURE_MODE = 3014 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sets the operation mode of the Exposure (or shutter).
    GX_ENUM_TRIGGER_SELECTOR = 3015 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the type of trigger to configure.
    GX_FLOAT_TRIGGER_DELAY = 3016 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Specifies the delay in microseconds (us) to apply after the trigger reception before activating it.
    GX_ENUM_TRANSFER_CONTROL_MODE = 3017 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the control method for the transfers.
    GX_ENUM_TRANSFER_OPERATION_MODE = 3018 | GX_FEATURE_ENUM
    ...
    GX_INT_TRANSFER_BLOCK_COUNT = 3020 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< frame number of transmission. when set GX_ENUM_TRANSFER_OPERATION_MODE as GX_ENUM_TRANSFER_OPERATION_MODE_MULTIBLOCK, this function is activated
    GX_BOOL_FRAMESTORE_COVER_ACTIVE =
        3021 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< FrameBufferOverwriteActive
    GX_ENUM_ACQUISITION_FRAME_RATE_MODE = 3022 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls if the acquisitionFrameRate is active, see also GX_ACQUISITION_FRAME_RATE_MODE_ENTRY
    GX_FLOAT_ACQUISITION_FRAME_RATE = 3023 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls the acquisition rate (in Hertz) at which the frames are captured.
    GX_FLOAT_CURRENT_ACQUISITION_FRAME_RATE = 3024 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Indicates the maximum allowed frame acquisition rate.
    GX_ENUM_FIXED_PATTERN_NOISE_CORRECT_MODE = 3025 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls if the FixedPatternNoise is active, see also GX_FIXED_PATTERN_NOISE_CORRECT_MODE
    GX_INT_ACQUISITION_BURST_FRAME_COUNT =
        3030 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< frame number of transmission.
    GX_ENUM_ACQUISITION_STATUS_SELECTOR = 3031 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Acquisition status selection, see also GX_ACQUISITION_STATUS_SELECTOR_ENTRY
    ...
    GX_FLOAT_EXPOSURE_OVERLAP_TIME_MAX =
        30301 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Maximum overlap exposure time
    GX_ENUM_EXPOSURE_TIME_MODE = 30302 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Exposure time mode, see also GX_EXPOSURE_TIME_MODE_ENTRY
    GX_ENUM_ACQUISITION_BURST_MODE = 30303 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Burst acquisition mode，see also GX_EXPOSURE_TIME_MODE_ENTRY
    GX_ENUM_OVERLAP_MODE = 30304 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< overlap mode,refer to GX_OVERLAP_MODE_ENTRY
    GX_ENUM_MULTISOURCE_SELECTOR = 30305 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< MultiSourceSelector to GX_MULTISOURCE_SELECTOR_ENTRY
    GX_BOOL_MULTISOURCE_ENABLE =
        30306 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< MultiSource Trigger Enable
    GX_BOOL_TRIGGER_CACHE_ENABLE =
        30307 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Trigger Cache Enable

    //----------------DigitalIO Section----------------------------------
    GX_ENUM_USER_OUTPUT_SELECTOR = 4000 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which bit of the User Output register will be set by UserOutputValue.
    GX_BOOL_USER_OUTPUT_VALUE = 4001 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sets the value of the bit selected by UserOutputSelector.
    GX_ENUM_USER_OUTPUT_MODE = 4002 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Output signal can be used for different purposes, flash or a user-defined constant level, see also GX_USER_OUTPUT_MODE_ENTRY
    GX_ENUM_STROBE_SWITCH = 4003 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Set the flash light switch, see also GX_STROBE_SWITCH_ENTRY
    GX_ENUM_LINE_SELECTOR = 4004 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the physical line (or pin) of the external device connector to configure.
    GX_ENUM_LINE_MODE = 4005 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls if the physical Line is used to Input or Output a signal.
    GX_BOOL_LINE_INVERTER = 4006 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls the inversion of the signal of the selected input or output Line.
    GX_ENUM_LINE_SOURCE = 4007 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which internal acquisition or I/O source signal to output on the selected Line.
    GX_BOOL_LINE_STATUS = 4008 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Returns the current status of the selected input or output Line.
    GX_INT_LINE_STATUS_ALL = 4009 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Returns the current status of all available Line signals at time of polling in a single bit field.
    GX_FLOAT_PULSE_WIDTH = 4010 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV,
    GX_INT_LINE_RANGE =
        4011 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Flash lamp pulse width
    GX_INT_LINE_DELAY = 4012 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Flash Delay
    GX_INT_LINE_FILTER_RAISING_EDGE =
        4013 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Pin rising edge filtering
    GX_INT_LINE_FILTER_FALLING_EDGE =
        4014 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Pin falling edge filtering

    //----------------AnalogControls Section----------------------------
    GX_ENUM_GAIN_AUTO = 5000 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sets the automatic gain control (AGC) mode.
    GX_ENUM_GAIN_SELECTOR = 5001 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which Gain is controlled by the various Gain features.
    GX_ENUM_BLACKLEVEL_AUTO = 5003 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls the mode for automatic black level adjustment.
    GX_ENUM_BLACKLEVEL_SELECTOR = 5004 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which Black Level is controlled by the various Black Level features.
    GX_ENUM_BALANCE_WHITE_AUTO = 5006 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls the mode for automatic white balancing between the color channels.
    GX_ENUM_BALANCE_RATIO_SELECTOR = 5007 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which Balance ratio to control.
    GX_FLOAT_BALANCE_RATIO = 5008 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls ratio of the selected color component to a reference color component.
    GX_ENUM_COLOR_CORRECT = 5009 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Color correction, see also GX_COLOR_CORRECT_ENTRY
    GX_ENUM_DEAD_PIXEL_CORRECT = 5010 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< The dead pixel correct function can eliminate dead pixels in the image, see also GX_DEAD_PIXEL_CORRECT_ENTRY
    GX_FLOAT_GAIN = 5011 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< The value is an float value that sets the selected gain control in units specific to the camera.
    GX_FLOAT_BLACKLEVEL = 5012 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Controls the analog black level as an absolute physical value.
    GX_BOOL_GAMMA_ENABLE =
        5013 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Enable bit of Gamma
    GX_ENUM_GAMMA_MODE = 5014 | GX_FEATURE_ENUM
    ...
    GX_ENUM_LIGHT_SOURCE_PRESET = 5017 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Light source preset, see also GX_LIGHT_SOURCE_PRESET_ENTRY
    GX_BOOL_BLACKLEVEL_CALIB_STATUS =
        5018 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< BlackLevelCalibStatus
    GX_INT_BLACKLEVEL_CALIB_VALUE =
        5019 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< BlackLevelCalibValue
    GX_FLOAT_PGA_GAIN =
        5020 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< PGAGain BlackLevelCalibStatus

    //---------------CustomFeature Section-------------------------
    GX_INT_ADC_LEVEL = 6000 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< When the pixel size is not 8bits, this function can be used to choose 8bits form 10bits or 12bit for show image.
    GX_INT_H_BLANKING =
    ...
    GX_INT_GRAY_VALUE =
        6006 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< ExpectedGrayValue_InqIsImplemented
    GX_ENUM_AA_LIGHT_ENVIRONMENT = 6007 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Automatic function according to the external light conditions better for accommodation, see also GX_AA_LIGHT_ENVIRMENT_ENTRY
    GX_INT_AAROI_OFFSETX = 6008 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This value sets the X offset (left offset) for the rect of interest in pixels for 2A, i.e., the distance in pixels between the left side of the image area and the left side of the AAROI.
    GX_INT_AAROI_OFFSETY = 6009 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This value sets the Y offset (top offset) for the rect of interest for 2A, i.e., the distance in pixels between the top of the image area and the top of the AAROI.
    GX_INT_AAROI_WIDTH = 6010 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This value sets the width of the rect of interest in pixels for 2A.
    GX_INT_AAROI_HEIGHT = 6011 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This value sets the height of the rect of interest in pixels for 2A.
    GX_FLOAT_AUTO_GAIN_MIN = 6012 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Setting up automatic gain range of minimum. When the gain is set to auto mode, this function works.
    GX_FLOAT_AUTO_GAIN_MAX = 6013 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Setting up automatic gain range of maximum. When the gain is set to auto mode, this function works.
    GX_FLOAT_AUTO_EXPOSURE_TIME_MIN = 6014 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Setting up automatic shutter range of minimum. When the shutter is set to auto mode, this function works.
    GX_FLOAT_AUTO_EXPOSURE_TIME_MAX = 6015 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Setting up automatic shutter range of maximum. When the shutter is set to auto mode, this function works.
    ...
    GX_ENUM_IMAGE_GRAY_RAISE_SWITCH = 6020 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Control ImageGrayRaise is valid, see also GX_IMAGE_GRAY_RAISE_SWITCH_ENTRY
    GX_ENUM_AWB_LAMP_HOUSE = 6021 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Refers to the AWB working environment, see also GX_AWB_LAMP_HOUSE_ENTRY
    GX_INT_AWBROI_OFFSETX = 6022 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This value sets the X offset (left offset) for the rect of interest in pixels for Auto WhiteBalance
    GX_INT_AWBROI_OFFSETY = 6023 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This value sets the Y offset (top offset) for the rect of interest for Auto WhiteBalance
    GX_INT_AWBROI_WIDTH = 6024 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This value sets the width of the rect of interest in pixels for Auto WhiteBalance
    GX_INT_AWBROI_HEIGHT = 6025 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This value sets the height of the rect of interest in pixels for Auto WhiteBalance
    ...
    GX_ENUM_USER_DATA_FILED_SELECTOR = 6028 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< User selects the flash data field, refer to GX_USER_DATA_FILED_SELECTOR_ENTRY for area selection
    GX_BUFFER_USER_DATA_FILED_VALUE =
        6029 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< User data field content
    GX_ENUM_FLAT_FIELD_CORRECTION = 6030 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Flat field correction switch, see also GX_FLAT_FIELD_CORRECTION_ENTRY
    GX_ENUM_NOISE_REDUCTION_MODE = 6031 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Noise reduction mode, see also GX_NOISE_REDUCTION_MODE_ENTRY
    GX_FLOAT_NOISE_REDUCTION =
        6032 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Noise reduction
    GX_BUFFER_FFCLOAD = 6033 | GX_FEATURE_BUFFER
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Get flat field correction parameters
    GX_BUFFER_FFCSAVE = 6034 | GX_FEATURE_BUFFER
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Set flat field correction parameters
    GX_ENUM_STATIC_DEFECT_CORRECTION = 6035 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Static defect correction, Refer to GX_ENUM_STATIC_DEFECT_CORRECTION_ENTRY
    GX_ENUM_2D_NOISE_REDUCTION_MODE = 6036 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 2D Noise Reduction Mode, Refer to GX_2D_NOISE_REDUCTION_MODE_ENTRY
    GX_ENUM_3D_NOISE_REDUCTION_MODE = 6037 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 3D Noise Reduction Mode, Refer to GX_3D_NOISE_REDUCTION_MODE_ENTRY
    ...
    GX_BUFFER_STATIC_DEFECT_CORRECTION_VALUE_ALL = 6039 | GX_FEATURE_BUFFER
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< static defect correction value, Refer to GX_BUFFER_FFCSAVE
    GX_BUFFER_STATIC_DEFECT_CORRECTION_FLASH_VALUE = 6040 | GX_FEATURE_BUFFER
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< static defect correction flash value, Refer to GX_BUFFER_FFCSAVE
    GX_INT_STATIC_DEFECT_CORRECTION_FINISH = 6041 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< static defect correction finish, Refer to GX_INT_AWBROI_HEIGHT
    GX_BUFFER_STATIC_DEFECT_CORRECTION_INFO = 6042 | GX_FEATURE_BUFFER
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< static defect correction info, Refer to GX_BUFFER_FFCSAVE
    GX_COMMAND_STRIP_CALIBRATION_START =
        6043 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Starts the strip calibration
    GX_COMMAND_STRIP_CALIBRATION_STOP = 6044 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Ready to stop the strip calibration
    GX_BUFFER_USER_DATA_FILED_VALUE_ALL =
        6045 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Continuous user area content
    GX_ENUM_SHADING_CORRECTION_MODE =
        6046 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Shade correction mode
    GX_COMMAND_FFC_GENERATE = 6047 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Generate flat field correction factor
    GX_ENUM_FFC_GENERATE_STATUS =
        6048 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Level-field correction status
    GX_ENUM_FFC_EXPECTED_GRAY_VALUE_ENABLE = 6049 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Level-field correction expected gray value enable
    GX_INT_FFC_EXPECTED_GRAY = 6050 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Flat-field correction expected gray value
    GX_INT_FFC_COEFFICIENTS_SIZE =
        6051 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Level-field correction factor size
    GX_BUFFER_FFC_VALUE_ALL =
        6052 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Level-field correction value
    GX_ENUM_DSNU_SELECTOR = 6053 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selection of dark field correction coefficient
    GX_COMMAND_DSNU_GENERATE = 6054 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Generate dark field correction factor
    GX_ENUM_DSNU_GENERATE_STATUS =
        6055 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Dark field correction status
    GX_COMMAND_DSNU_SAVE = 6056 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Save dark-field correction factor
    GX_COMMAND_DSNU_LOAD = 6057 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Load dark-field correction factor
    GX_ENUM_PRNU_SELECTOR = 6058 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selection of bright field correction coefficient
    GX_COMMAND_PRNU_GENERATE = 6059 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Generate bright field correction factor
    GX_ENUM_PRNU_GENERATE_STATUS =
        6060 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Bright-field correction status
    GX_COMMAND_PRNU_SAVE = 6061 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Save the bright field correction factor
    GX_COMMAND_PRNU_LOAD = 6062 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Loaded open field correction factor
    GX_BUFFER_DATA_FIELD_VALUE_ALL =
        6063 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Data field value
    GX_INT_STATIC_DEFECT_CORRECTION_CALIB_STATUS = 6064 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Static bad point calibration status
    GX_INT_FFC_FACTORY_STATUS = 6065 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Level-field correction status detection
    GX_INT_DSNU_FACTORY_STATUS = 6066 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Detection of dark-field correction state
    GX_INT_PRNU_FACTORY_STATUS = 6067 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Open field correction state detection
    GX_BUFFER_DETECT =
        6068 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Buffer detection（CXP）
    GX_ENUM_FFC_COEFFICIENT = 6069 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selection of flat field correction coefficient

    //---------------UserSetControl Section-------------------------
    GX_ENUM_USER_SET_SELECTOR = 7000 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the feature User Set to load, save or configure.
    GX_COMMAND_USER_SET_LOAD = 7001 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Loads the User Set specified by UserSetSelector to the device and makes it active.
    GX_COMMAND_USER_SET_SAVE = 7002 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Save the User Set specified by UserSetSelector to the non-volatile memory of the device.
    GX_ENUM_USER_SET_DEFAULT = 7003 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the feature User Set to load and make active by default when the device is reset.
    GX_INT_DATA_FIELD_VALUE_ALL_USED_STATUS =
        7004 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Factory status of user data area
    ...
    GX_ENUM_EVENT_NOTIFICATION = 8001 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Activate or deactivate the notification to the host application of the occurrence of the selected Event.
    GX_INT_EVENT_EXPOSUREEND = 8002 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Returns the unique identifier of the ExposureEnd type of Event.
    ...
    GX_INT_EVENT_EXPOSUREEND_FRAMEID = 8004 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Returns the unique Identifier of the Frame (or image) that generated the ExposureEnd Event.
    GX_INT_EVENT_BLOCK_DISCARD = 8005 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This enumeration value indicates the BlockDiscard event ID.
    ...
    GX_INT_EVENT_OVERRUN = 8007 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This enumeration value indicates the EventOverrun event ID.
    ...
    GX_INT_EVENT_FRAMESTART_OVERTRIGGER = 8009 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< This enumeration value indicates the FrameStartOverTrigger event ID.
    GX_INT_EVENT_FRAMESTART_OVERTRIGGER_TIMESTAMP = 8010 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Indicates the time stamp of the FrameStartOverTrigger event
    ...
    GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER = 8015 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame burst start overtrigger event ID
    GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER_FRAMEID = 8016 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame burst start overtrigger event frame ID
    GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER_TIMESTAMP = 8017 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame burst start overtrigger event timestamp
    GX_INT_EVENT_FRAMESTART_WAIT =
        8018 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame start wait event ID
    GX_INT_EVENT_FRAMESTART_WAIT_TIMESTAMP =
        8019 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame start wait event timestamp
    GX_INT_EVENT_FRAMEBURSTSTART_WAIT =
        8020 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame burst start wait event ID
    GX_INT_EVENT_FRAMEBURSTSTART_WAIT_TIMESTAMP = 8021 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame burst start wait event timestamp
    GX_INT_EVENT_BLOCK_DISCARD_FRAMEID =
        8022 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Data block discard event frame ID
    GX_INT_EVENT_FRAMESTART_OVERTRIGGER_FRAMEID = 8023 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame start wait overtrigger event frame ID
    GX_INT_EVENT_BLOCK_NOT_EMPTY_FRAMEID = 8024 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Data block not empty event frame ID
    GX_INT_EVENT_FRAMESTART_WAIT_FRAMEID =
        8025 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame start wait event frame ID
    GX_INT_EVENT_FRAMEBURSTSTART_WAIT_FRAMEID = 8026 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame burst start wait event frame ID
    GX_ENUM_EVENT_SIMPLE_MODE = 8027 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< event block ID enable,refer to GX_EVENT_SIMPLE_MODE_ENTRY

    //---------------LUT Section-------------------------
    GX_ENUM_LUT_SELECTOR =
        9000 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which LUT to control.
    GX_BUFFER_LUT_VALUEALL = 9001 | GX_FEATURE_BUFFER
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Accesses all the LUT coefficients in a single access without using individual LUTIndex.
    GX_BOOL_LUT_ENABLE =
        9002 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Activates the selected LUT.
    GX_INT_LUT_INDEX = 9003 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Control the index (offset) of the coefficient to access in the selected LUT.
    GX_INT_LUT_VALUE = 9004 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Returns the Value at entry LUTIndex of the LUT selected by LUTSelector.
    GX_INT_LUT_FACTORY_STATUS =
        9005 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Lookup table factory status

    //---------------ChunkData Section-------------------------
    GX_BOOL_CHUNKMODE_ACTIVE = 10001 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Activates the inclusion of Chunk data in the payload of the image.
    GX_ENUM_CHUNK_SELECTOR = 10002 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which Chunk to enable or control.
    GX_BOOL_CHUNK_ENABLE = 10003 | GX_FEATURE_BOOL
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Enables the inclusion of the selected Chunk data in the payload of the image.

    //---------------Color Transformation Control-------------------------
    GX_ENUM_COLOR_TRANSFORMATION_MODE = 11000 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Color conversion selection, see also GX_COLOR_TRANSFORMATION_MODE_ENTRY
    ...
    GX_ENUM_COLOR_TRANSFORMATION_VALUE_SELECTOR = 11002 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the Gain factor or Offset of the Transformation matrix to access in the selected Color Transformation module.
    GX_FLOAT_COLOR_TRANSFORMATION_VALUE = 11003 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Represents the value of the selected Gain factor or Offset inside the Transformation matrix.
    GX_ENUM_SATURATION_MODE = 11004 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Saturation mode, Refer to GX_ENUM_SATURATION_MODE_ENTRY
    ...
    GX_ENUM_TIMER_SELECTOR = 12000 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which Counter to configure, Refer to GX_TIMER_SELECTOR_ENTRY
    GX_FLOAT_TIMER_DURATION = 12001 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sets the duration (in microseconds) of the Timer pulse.
    GX_FLOAT_TIMER_DELAY = 12002 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sets the duration (in microseconds) of the delay to apply at the reception of a trigger before starting the Timer.
    GX_ENUM_TIMER_TRIGGER_SOURCE = 12003 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the source of the trigger to start the Timer, Refer to GX_TIMER_TRIGGER_SOURCE_ENTRY
    GX_ENUM_COUNTER_SELECTOR = 12004 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects which Counter to configure, Refer to GX_COUNTER_SELECTOR_ENTRY
    GX_ENUM_COUNTER_EVENT_SOURCE = 12005 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Select the events that will be the source to increment the Counter, Refer to GX_COUNTER_EVENT_SOURCE_ENTRY
    GX_ENUM_COUNTER_RESET_SOURCE = 12006 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the signals that will be the source to reset the Counter, Refer to GX_COUNTER_RESET_SOURCE_ENTRY
    GX_ENUM_COUNTER_RESET_ACTIVATION = 12007 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Selects the Activation mode of the Counter Reset Source signal, Refer to GX_COUNTER_RESET_ACTIVATION_ENTRY
    GX_COMMAND_COUNTER_RESET = 12008 | GX_FEATURE_COMMAND
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Does a software reset of the selected Counter and starts it.
    GX_ENUM_COUNTER_TRIGGER_SOURCE = 12009 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Counter trigger source, see also GX_COUNTER_TRIGGER_SOURCE_ENTRY
    GX_INT_COUNTER_DURATION =
        12010 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Counter duration
    GX_ENUM_TIMER_TRIGGER_ACTIVATION = 12011 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Timer Trigger Activation see also GX_TIMER_TRIGGER_ACTIVATION_ENTRY
    GX_INT_COUNTER_VALUE = 12012 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< counter value

    //---------------RemoveParameterLimitControl Section-------------------------
    GX_ENUM_REMOVE_PARAMETER_LIMIT = 13000 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Remove parameter range restriction, see also GX_REMOVE_PARAMETER_LIMIT_ENTRY

    //---------------HDRControl Section-------------------------
    GX_ENUM_HDR_MODE = 14000 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< HDR Mode, Refer to GX_HDR_MODE_ENTRY
    GX_INT_HDR_TARGET_LONG_VALUE = 14001 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Set the target gray value of the long-exposure image.
    GX_INT_HDR_TARGET_SHORT_VALUE = 14002 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Set the target gray value of the short-exposure image.
    GX_INT_HDR_TARGET_MAIN_VALUE = 14003 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Set the target gray value of the HDR image.

    //---------------MultiGrayControl Section-------------------------
    GX_ENUM_MGC_MODE = 15001 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Multi-gray Control mode, Refer to GX_MGC_MODE_ENTRY
    GX_INT_MGC_SELECTOR =
        15002 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< select Multi-gray Control.
    GX_FLOAT_MGC_EXPOSURE_TIME = 15003 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Multi-gray Control ExposureTime.
    GX_FLOAT_MGC_GAIN =
        15004 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Multi-gray Control Gain.

    //---------------ImageQualityControl Section-------------------------
    GX_BUFFER_STRIPED_CALIBRATION_INFO = 16001 | GX_FEATURE_BUFFER
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< striped calibration info, Refer to GX_BUFFER_STATIC_DEFECT_CORRECTION_INFO
    ...
    GX_ENUM_IMU_CONFIG_ACC_RANGE = 17002 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Accelerometer measurement range，see also GX_IMU_CONFIG_ACC_RANGE_ENTRY
    GX_ENUM_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_SWITCH = 17003 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Accelerometer low-pass filter switch, see also GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_SWITCH_ENTRY
    GX_ENUM_IMU_CONFIG_ACC_ODR = 17004 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Accelerometer output data rate，see also GX_IMU_CONFIG_ACC_ODR_ENTRY
    GX_ENUM_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY = 17005 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Accelerometer Accelerometer Low Pass Cutoff Frequency，see also GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY_ENTRY
    GX_ENUM_IMU_CONFIG_GYRO_XRANGE = 17006 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Measuring range of gyroscope in X direction，see also GX_IMU_CONFIG_GYRO_RANGE_ENTRY
    GX_ENUM_IMU_CONFIG_GYRO_YRANGE = 17007 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Measuring range of gyroscope in Y direction，see also GX_IMU_CONFIG_GYRO_RANGE_ENTRY
    GX_ENUM_IMU_CONFIG_GYRO_ZRANGE = 17008 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Measuring range of gyroscope in Z direction，see also GX_IMU_CONFIG_GYRO_RANGE_ENTRY
    GX_ENUM_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_SWITCH = 17009 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Gyroscope low-pass filter switch，see also GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_SWITCH_ENTRY
    GX_ENUM_IMU_CONFIG_GYRO_ODR = 17010 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Gyroscope output data rate，see also GX_IMU_CONFIG_GYRO_ODR_ENTRY
    GX_ENUM_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY = 17011 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Accelerometer Low Pass Cutoff Frequency，see also GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_ENTRY
    GX_FLOAT_IMU_ROOM_TEMPERATURE = 17012 | GX_FEATURE_FLOAT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Gyroscope temperature room temperature setting
    GX_ENUM_IMU_TEMPERATURE_ODR = 17013 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Thermometer output data rate setting，see also GX_IMU_TEMPERATURE_ODR_ENTRY

    //---------------FrameBufferControl Section-------------------------
    GX_INT_FRAME_BUFFER_COUNT =
        18001 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Frame storage depth
    GX_COMMAND_FRAME_BUFFER_FLUSH =
        18002 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Clear frame memory

    //----------------SerialPortControl Section----------------------------------
    GX_ENUM_SERIALPORT_SELECTOR =
        19001 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Serial port selection
    GX_ENUM_SERIALPORT_SOURCE =
        19002 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Serial port input source
    GX_ENUM_SERIALPORT_BAUDRATE =
        19003 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Serial baud rate
    GX_INT_SERIALPORT_DATA_BITS =
        19004 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Serial port data bit
    GX_ENUM_SERIALPORT_STOP_BITS =
        19005 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Serial port stop bit
    GX_ENUM_SERIALPORT_PARITY =
        19006 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Serial port parity
    GX_INT_TRANSMIT_QUEUE_MAX_CHARACTER_COUNT = 19007 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Maximum number of characters in transmission queue
    GX_INT_TRANSMIT_QUEUE_CURRENT_CHARACTER_COUNT = 19008 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Current number of characters in the transmission queue
    GX_INT_RECEIVE_QUEUE_MAX_CHARACTER_COUNT = 19009 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Maximum number of characters in receive queue
    GX_INT_RECEIVE_QUEUE_CURRENT_CHARACTER_COUNT = 19010 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Current number of characters in the receive queue
    GX_INT_RECEIVE_FRAMING_ERROR_COUNT =
        19011 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Received frame error count
    GX_INT_RECEIVE_PARITY_ERROR_COUNT =
        19012 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Receive parity error count
    GX_COMMAND_RECEIVE_QUEUE_CLEAR =
        19013 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Queue Clear
    GX_BUFFER_SERIALPORT_DATA =
        19014 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< serial data
    GX_INT_SERIALPORT_DATA_LENGTH =
        19015 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Serial port data length
    GX_INT_SERIAL_PORT_DETECTION_STATUS =
        19016 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Serial port status detection

    //---------------CoaXPress Section-------------------------
    GX_ENUM_CXP_LINK_CONFIGURATION =
        20001 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Connection configuration
    GX_ENUM_CXP_LINK_CONFIGURATION_PREFERRED =
        20002 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Preset connection configuration
    GX_ENUM_CXP_LINK_CONFIGURATION_STATUS = 20003 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< CXP connection configuration status
    GX_INT_IMAGE1_STREAM_ID =
        20004 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< First image flow ID
    GX_ENUM_CXP_CONNECTION_SELECTOR =
        20005 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Connection selection
    GX_ENUM_CXP_CONNECTION_TEST_MODE =
        20006 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Connection test mode
    GX_INT_CXP_CONNECTION_TEST_ERROR_COUNT =
        20007 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Connection test error count
    GX_INT_CXP_CONNECTION_TEST_PACKET_RX_COUNT = 20008 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Number of connection test packets received
    GX_INT_CXP_CONNECTION_TEST_PACKET_TX_COUNT = 20009 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Number of connection test packets sent

    //--------------SequencerControl Section-------------------------
    GX_ENUM_SEQUENCER_MODE =
        21001 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer mode
    GX_ENUM_SEQUENCER_CONFIGURATION_MODE =
        21002 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer configuration mode
    GX_ENUM_SEQUENCER_FEATURE_SELECTOR =
        21003 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer function selector
    GX_BOOL_SEQUENCER_FEATURE_ENABLE =
        21004 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer function enabled
    GX_INT_SEQUENCER_SET_SELECTOR =
        21005 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer setting selector
    GX_INT_SEQUENCER_SET_COUNT =
        21006 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer count
    GX_INT_SEQUENCER_SET_ACTIVE =
        21007 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer settings active
    GX_COMMAND_SEQUENCER_SET_RESET =
        21008 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer setting reset
    GX_INT_SEQUENCER_PATH_SELECTOR =
        21009 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer payh selection
    GX_INT_SEQUENCER_SET_NEXT =
        21010 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer Next
    GX_ENUM_SEQUENCER_TRIGGER_SOURCE =
        21011 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer Trigger
    GX_COMMAND_SEQUENCER_SET_SAVE =
        21012 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer Save
    GX_COMMAND_SEQUENCER_SET_LOAD =
        21013 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Sequencer Load

    //--------------EnoderControl Section-------------------------
    GX_ENUM_ENCODER_SELECTOR =
        22001 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Encoder selector
    GX_ENUM_ENCODER_DIRECTION =
        22002 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Encoder direction
    GX_INT_ENCODER_VALUE = 22003 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Decoder value
    GX_ENUM_ENCODER_SOURCEA =
        22004 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Encoder phase A input
    GX_ENUM_ENCODER_SOURCEB =
        22005 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Encoder phase B input
    GX_ENUM_ENCODER_MODE = 22006 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Encoder Mode

    //////////////////////////////////////////////////////////////////////////
    /// Local device layer(Device Feature)
    //////////////////////////////////////////////////////////////////////////
    GX_DEV_INT_COMMAND_TIMEOUT = 0 | GX_FEATURE_INT
    ...
    GX_DS_INT_DELIVERED_FRAME_COUNT = 1 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_DS, ///< Number of received frames (including residual frames)
    GX_DS_INT_LOST_FRAME_COUNT = 2 | GX_FEATURE_INT
    ...
    GX_DS_INT_MAX_PACKET_COUNT_IN_ONE_BLOCK = 9 | GX_FEATURE_INT
        | GX_FEATURE_LEVEL_DS, ///< Maximum number of retransmissions of data blocks
    GX_DS_INT_MAX_PACKET_COUNT_IN_ONE_COMMAND = 10 | GX_FEATURE_INT
    ...
    GX_DS_ENUM_RESEND_MODE = 13 | GX_FEATURE_ENUM
    ...
    GX_DS_ENUM_STOP_ACQUISITION_MODE =
        21 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_DS, ///< stop acquisition mode
    GX_DS_ENUM_STREAM_BUFFER_HANDLING_MODE = 22 | GX_FEATURE_ENUM
        | GX_FEATURE_LEVEL_DS, ///< Buffer handling mode, see also GX_DS_STREAM_BUFFER_HANDLING_MODE_ENTRY
    GX_DS_INT_ACQUISITION_BUFFER_CACHE_PREC =
        23 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< Acquisition Buffer Cache Num Prec
} GX_FEATURE_ID;
...
typedef enum GX_PIXEL_FORMAT_ENTRY {
    ...
    GX_PIXEL_FORMAT_MONO10_PACKED =
        (GX_PIXEL_MONO | GX_PIXEL_12BIT | 0x0004), //0x010C0004,GigE Vision specific format
    GX_PIXEL_FORMAT_MONO12_PACKED =
        (GX_PIXEL_MONO | GX_PIXEL_12BIT | 0x0006), //0x010C0006,GigE Vision specific format
...
typedef enum GX_EVENT_SELECTOR_ENTRY {
    ...
    GX_ENUM_EVENT_SELECTOR_FRAMEBURSTSTART_OVERTRIGGER =
        0x9005, ///< Frame burst start overtrigger event
...
typedef enum GX_FFC_EXPECTED_GRAY_VALUE_ENABLE_ENTRY {
    GX_FFC_EXPECTED_GRAY_VALUE_ENABLE_OFF =
        0, ///< Disable flat field correction expected gray value
...
typedef enum GX_CXP_LINK_CONFIGURATION_PREFERRED_ENTRY {
    GX_CXP_LINK_CONFIGURATION_PREFERRED_CXP12_X4 =
        0x00040058, ///< Preset connection configuration CXP12_X4
} GX_CXP_LINK_CONFIGURATION_PREFERRED_ENTRY;

typedef enum GX_CXP_LINK_CONFIGURATION_STATUS_ENTRY {
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP6_X1 =
        0x00010048, ///< CXP Connection configuration status CXP6_X1
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP12_X1 =
        0x00010058, ///< CXP Connection configuration status CXP12_X1
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP6_X2 =
        0x00020048, ///< CXP Connection configuration status CXP6_X2
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP12_X2 =
        0x00020058, ///< CXP Connection configuration status CXP12_X2
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP6_X4 =
        0x00040048, ///< CXP Connection configuration status CXP6_X4
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP12_X4 =
        0x00040058, ///< CXP Connection configuration status CXP12_X4
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP3_X1 =
        0x00010038, ///< CXP Connection configuration status CXP3_X1
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP3_X2 =
        0x00020038, ///< CXP Connection configuration status CXP3_X2
    GX_CXP_LINK_CONFIGURATION_STATUS_CXP3_X4 =
        0x00040038, ///< CXP Connection configuration status CXP3_X4
...
typedef enum GX_SENSOR_SHUTTER_MODE_ENTRY {
    GX_SENSOR_SHUTTER_MODE_GLOBAL =
        0, ///< All pixels are exposed simultaneously with same exposure time
    GX_SENSOR_SHUTTER_MODE_ROLLING =
        1, ///< All pixels have the same exposure time, but exposure start at different time
    GX_SENSOR_SHUTTER_MODE_GLOBALRESET =
...
typedef enum GX_LIGHT_SOURCE_PRESET_ENTRY {
    ...
    GX_LIGHT_SOURCE_PRESET_COOL_WHITE_FLUORESCENCE =
        4, ///< Light house preset COOL_WHITE_FLUORESCENCE
...
typedef enum GX_COUNTER_EVENT_SOURCE_ENTRY {
    ...
    GX_COUNTER_EVENT_SOURCE_ACQUISITION_TRIGGER =
        3, ///< Count the number of "ACQUISITION_TRIGGER" events
...
typedef enum GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_SWITCH_ENTRY {
    ...
    GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_OFF =
        1, ///< Close the accelerometer low-pass filter switch
...
typedef enum GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY_ENTRY {
    GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY_ODR040 =
        0, ///< Accelerometer The accelerometer low-pass cutoff frequency isODR×0.40
    GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY_ODR025 =
        1, ///< Accelerometer The accelerometer low-pass cutoff frequency isODR×0.25
    GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY_ODR011 =
        2, ///< Accelerometer The accelerometer low-pass cutoff frequency isODR×0.11
    GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY_ODR004 =
        3, ///< Accelerometer The accelerometer low-pass cutoff frequency isODR×0.04
    GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY_ODR002 =
        4, ///< Accelerometer The accelerometer low-pass cutoff frequency isODR×0.02
} GX_IMU_CONFIG_ACC_ODR_LOW_PASS_FILTER_FREQUENCY_ENTRY;

typedef enum GX_IMU_CONFIG_GYRO_RANGE_ENTRY {
    GX_IMU_CONFIG_GYRO_RANGE_125DPS =
        2, ///< The measuring range of gyroscope in X direction is125dps
    GX_IMU_CONFIG_GYRO_RANGE_250DPS =
        3, ///< The measuring range of gyroscope in X direction is250dps
    GX_IMU_CONFIG_GYRO_RANGE_500DPS =
        4, ///< The measuring range of gyroscope in X direction is500dps
    GX_IMU_CONFIG_GYRO_RANGE_1000DPS =
        5, ///< The measuring range of gyroscope in X direction is1000dps
    GX_IMU_CONFIG_GYRO_RANGE_2000DPS =
        6, ///< 陀The measuring range of gyroscope in X direction is2000dps
...
typedef enum GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_ENTRY {
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF2000HZ =
        2000, ///< Accelerometer The accelerometer low-pass cutoff frequency is2000Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF1600HZ =
        1600, ///< Accelerometer The accelerometer low-pass cutoff frequency is1600Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF1525HZ =
        1525, ///< Accelerometer The accelerometer low-pass cutoff frequency is1525Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF1313HZ =
        1313, ///< Accelerometer The accelerometer low-pass cutoff frequency is1313Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF1138HZ =
        1138, ///< Accelerometer The accelerometer low-pass cutoff frequency is1138Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF1000HZ =
        1000, ///< Accelerometer The accelerometer low-pass cutoff frequency is1000Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF863HZ =
        863, ///< Accelerometer The accelerometer low-pass cutoff frequency is863Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF638HZ =
        638, ///< Accelerometer The accelerometer low-pass cutoff frequency is638Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF438HZ =
        438, ///< Accelerometer The accelerometer low-pass cutoff frequency is438Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF313HZ =
        313, ///< Accelerometer The accelerometer low-pass cutoff frequency is313Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF213HZ =
        213, ///< Accelerometer The accelerometer low-pass cutoff frequency is213Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF219HZ =
        219, ///< Accelerometer The accelerometer low-pass cutoff frequency is219Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF363HZ =
        363, ///< Accelerometer The accelerometer low-pass cutoff frequency is363Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF320HZ =
        320, ///< Accelerometer The accelerometer low-pass cutoff frequency is320Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF250HZ =
        250, ///< Accelerometer The accelerometer low-pass cutoff frequency is250Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF200HZ =
        200, ///< Accelerometer The accelerometer low-pass cutoff frequency is200Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF181HZ =
        181, ///< Accelerometer The accelerometer low-pass cutoff frequency is181Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF160HZ =
        160, ///< Accelerometer The accelerometer low-pass cutoff frequency is160Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF125HZ =
        125, ///< Accelerometer The accelerometer low-pass cutoff frequency is125Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF100HZ =
        100, ///< Accelerometer The accelerometer low-pass cutoff frequency is100Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF90HZ =
        90, ///< Accelerometer The accelerometer low-pass cutoff frequency is90Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF80HZ =
        80, ///< Accelerometer The accelerometer low-pass cutoff frequency is80Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF63HZ =
        63, ///< Accelerometer The accelerometer low-pass cutoff frequency is63Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF50HZ =
        50, ///< Accelerometer The accelerometer low-pass cutoff frequency is50Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF45HZ =
        45, ///< Accelerometer The accelerometer low-pass cutoff frequency is45Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF40HZ =
        40, ///< Accelerometer The accelerometer low-pass cutoff frequency is40Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF31HZ =
        31, ///< Accelerometer The accelerometer low-pass cutoff frequency is31Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF25HZ =
        25, ///< Accelerometer The accelerometer low-pass cutoff frequency is25Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF23HZ =
        23, ///< Accelerometer The accelerometer low-pass cutoff frequency is23Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF20HZ =
        20, ///< Accelerometer The accelerometer low-pass cutoff frequency is20Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF15HZ =
        15, ///< Accelerometer The accelerometer low-pass cutoff frequency is15Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF13HZ =
        13, ///< Accelerometer The accelerometer low-pass cutoff frequency is13Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF11HZ =
        11, ///< Accelerometer The accelerometer low-pass cutoff frequency is11Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF10HZ =
        10, ///< Accelerometer The accelerometer low-pass cutoff frequency is10Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF8HZ =
        8, ///< Accelerometer The accelerometer low-pass cutoff frequency is8Hz
    GX_IMU_CONFIG_GYRO_ODR_LOW_PASS_FILTER_FREQUENCY_GYROLPF6HZ =
        6, ///< Accelerometer The accelerometer low-pass cutoff frequency is6Hz
...
typedef struct GX_DEVICE_IP_INFO {
    char
        szDeviceID[GX_INFO_LENGTH_64_BYTE + 4]; ///< the unique identifier of the device, 64+4 bytes
    ...
    char szNICMAC
        [GX_INFO_LENGTH_32_BYTE]; ///< the MAC address of the corresponding NIC(Network Interface Card), 32 bytes
    char szNICIP[GX_INFO_LENGTH_32_BYTE]; ///< the IP address of the corresponding NIC, 32 bytes
    char szNICSubNetMask
        [GX_INFO_LENGTH_32_BYTE]; ///< the subnet mask of the corresponding NIC, 32 bytes
    char szNICGateWay[GX_INFO_LENGTH_32_BYTE]; ///< the gateway of the corresponding NIC, 32 bytes
    char szNICDescription
        [GX_INFO_LENGTH_128_BYTE + 4]; ///< the description of the corresponding NIC, 128+4 bytes
...
typedef struct GX_DEVICE_BASE_INFO {
    ...
    GX_ACCESS_STATUS_CMD
    accessStatus; ///< access status that is currently supported by the device. Refer to GX_ACCESS_STATUS, 4 bytes
...
typedef struct GX_FRAME_CALLBACK_PARAM {
    ...
    const void*
        pImgBuf; ///< The image data address (After the frame information is enabled, the pImgBuf contains image data and frame information data)
    int32_t
...
typedef struct GX_FRAME_BUFFER {
    GX_FRAME_STATUS nStatus; ///< The state of the acquired image. Please refer to GX_FRAME_STATUS
    void*
        pImgBuf; ///< The image data pointer (After the frame information is enabled, the pImgBuf contains image data and frame information data)
    int32_t nWidth; ///< Image width
    int32_t nHeight; ///< Image height
    int32_t nPixelFormat; ///< Pixel format of image
    int32_t
...
typedef struct GX_ENUM_DESCRIPTION {
    ...
    char szSymbolic
        [GX_INFO_LENGTH_64_BYTE]; ///< The character description information of the enumeration item, 64 bytes
    int32_t reserved[8]; ///< 32 bytes,reserved
} GX_ENUM_DESCRIPTION;
...
\param      [in]pOpenParam          The open device parameter which is configured by user. Ref:GX_OPEN_PARAM.
...
//----------------------------------------------------------------------------------
GX_API
GXGetFeatureName(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, char* pszName, size_t* pnSize);
...
//----------------------------------------------------------------------------------
GX_API
GXGetFloatRange(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, GX_FLOAT_RANGE* pFloatRange);
...
//----------------------------------------------------------------------------------
GX_API
GXGetEnumEntryNums(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, uint32_t* pnEntryNums);
...
//----------------------------------------------------------------------------------
GX_API
GXGetString(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, char* pszContent, size_t* pnSize);
...
//----------------------------------------------------------------------------------
GX_API
GXGetBuffer(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, uint8_t* pBuffer, size_t* pnSize);
...
//----------------------------------------------------------------------------------
GX_API
GXSetBuffer(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, uint8_t* pBuffer, size_t nSize);
...
//----------------------------------------------------------------------------------
GX_API
GXRegisterCaptureCallback(GX_DEV_HANDLE hDevice, void* pUserParam, GXCaptureCallBack callBackFun);
...
//----------------------------------------------------------------------------------
GX_API
GXReadRemoteDevicePort(GX_DEV_HANDLE hDevice, uint64_t ui64Address, void* pBuffer, size_t* piSize);
