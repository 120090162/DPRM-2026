 ...
 */
#ifndef __DPRM_KALMAN_INTERFACE_TRACK_QUEUE_V2_H__
#define __DPRM_KALMAN_INTERFACE_TRACK_QUEUE_V2_H__
...
public:
    ...
    TQstateV2(): last_t(getTime()), count(0), keep(5), exist(false), available(false) {
        model = new EKF<11, 4>();
...
public:
    ...
    void setAngleDiffer(double d) {
        this->angle_diff_ = d;
    } // 设置认为是同一目标的最大夹角
    void setToggleAngle(double d) {
        this->toggle_angle_ = d;
    } // 设置切换目标的与中心连线夹角之差
