...
enum FindPointMethod { FIND_POINT_METHOD_BARYCENTER, FIND_POINT_METHOD_RECT_CROSSPOINT };

enum TeamColor { TEAM_COLOR_BLUE, TEAM_COLOR_RED };

enum ArmorColor { ARMOR_COLOR_BLUE, ARMOR_COLOR_RED, ARMOR_COLOR_NONE, ARMOR_COLOR_PURPLE };

enum ArmorSize { ARMOR_SIZE_UNKNOWN, ARMOR_SIZE_SMALL_ARMOR, ARMOR_SIZE_BIG_ARMOR };
